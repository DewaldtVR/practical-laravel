...
<body>
    <table cellpadding="0" cellspacing="0" border="0" id="backgroundTable" bgcolor="#002333">
        <tr>
            <td style="background-color: #002333" colspan="3" bgcolor="#002333">
                <img class="top-banner" style="width: 100%"
        ...
        <tr>
            <td colspan="3"
                style="font-family: Questrial, Arial, Helvetica, sans-serif; align-self: center; width: 800px; color: #ffffff;">
                ...
                <p style="color: #ffffff; text-align: center;">
                    ...
                    <a href="http://practical.test/">Login Admin Portal</a><br /><br />
                ...
                <table style="width: 100%">
                    <tr>
                        <td style="width: 358px">
                            <img src="https://www.cardcurator.com/hubfs/CardCurator/images/email_files/Footer-Image.png"
                                style="height: 70%" alt="Email Footer" />
                        </td>
                        <td></td>
                        <td style="text-align: right; width: 213px" width="213">
                            <table width="100%">
                                <tr>
                                    <td width="40">
                                        <a href="https://www.instagram.com/card_curator/"><img alt="Instagram"
                          ...
                          "
                                    ...
                                    <td width="40">
                                        <a href="https://www.facebook.com/CardCurator"><img alt="Facebook"
                          ...
                          "
                                    ...
                                    <td width="40">
                                        <a href="https://www.linkedin.com/company/cardcurator/"><img alt="LinkedIn"
                          ...
                          "
                                    ...
                                    <td width="40">
                                        <a href="https://twitter.com/Card_Curator"><img alt="Twitter"
