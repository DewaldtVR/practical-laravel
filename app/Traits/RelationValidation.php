...
trait RelationValidation
{
    ...
    {
        $this->addValidator(Required::create($this->relationshipName, $description));
        return $this;
    }

    public function pattern($description = "This field is not valid", $pattern)
    {
        $this->addValidator(Pattern::create($this->relationshipName, $description, $pattern));
        return $this;
    }
